...
export function RewardsTab(props: {
  ...
  const rewardTokenBalance = useYearnToken({
    address: vaultData.rewardsToken,
  ...
  const isYBoldVault = props.currentVault.address === toAddress('0x9F4330700a36B29952869fac9b33f45EEdd8A3d8')
  ...
  const onUnstake = useCallback(async (): Promise<void> => {
    ...
    const id = await handleUnstakeNotification({
          ...
          <div className={'flex flex-col gap-2'}>
            ...
            <div className={'flex flex-col gap-4 md:flex-row'}>
              ...
              <Button
                ...
                isDisabled={!isActive || Number(vaultData.vaultBalanceOf.display) <= 0 || isLargerThanVaultBalance}
              >
